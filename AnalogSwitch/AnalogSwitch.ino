...
const char* SSID_STA_g = DEFAULT_STA_SSID;
#else
...
#if defined(ENABLE_ARDUINO_OTA) && defined(ENABLE_WIFI)
...
#endif // defined(ENABLE_ARDUINO_OTA) && defined(ENABLE_WIFI
...
#if defined(ENABLE_WIFI) && defined(ENABLE_ARDUINO_OTA)

    ArduinoOTA.handle();

#endif // defined(ENABLE_WIFI) && defined(ENABLE_ARDUINO_OTA)
